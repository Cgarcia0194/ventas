                ...
                <table class="table table-striped table-bordered table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Total unidades vendidas</th>
                        <tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td >
                                <a href="edit_sale.php?id=<?php echo (int)$recent_sale['id']; ?>">
                                    <?php echo remove_junk(first_character($recent_sale['customer_name'])); ?>
                                </a>
                            </td>
                            <td class="text-center">$<?php echo remove_junk(first_character($recent_sale['total'])); ?></td>
                            <td class="text-center"><?php echo read_date(remove_junk(ucfirst($recent_sale['insert_date']))); ?></td>
