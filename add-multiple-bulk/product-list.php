<div id="product-grid">
    ...
    <img src="<?php echo $product_array[$key]["media_id"]; ?>" onclick="selectImage(<?php echo $product_array[$key]["id"] ?>);"/>
                <div class="product-title">
                 <input type="checkbox" class="checkstatus" name="chk_product[]" data-id="<?php echo $product_array[$key]["id"]; ?>" data-code="<?php echo $product_array[$key]["quantity"]; ?>"><?php echo $product_array[$key]["name"]; ?></br>
			<?php echo "$".$product_array[$key]["sale_price"]; ?></br>
			</div>
            </div>
